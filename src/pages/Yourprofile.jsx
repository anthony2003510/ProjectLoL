  ...
  return (
    ...
    Buscar invocador
            ...
            <div className="text-center w-full">
                <form className="w-full items-center pt-5">
          ...
          {JSON.stringify(summonerData) != "{}" ? (
            <div className="p-5 text-center">
              <h2  style={{fontSize: "4vw"}} className="mb-4leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
                {summonerData.name}
              </h2> 
