    ...
    <h1>Champions</h1>
      {
        championsPjs?.map((pj,i)=>( 
          <a onClick={()=>
          {
            setchampionName(pj.id)
            console.log(championName)

          }} href='#' key={i} className="flex flex-row items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-[#091428] dark:hover:bg-gray-800">
