...
export function ChampionContextProvider({children}) {
    const urlchampions = 'http://ddragon.leagueoflegends.com/cdn/13.6.1/data/es_ES/champion.json'
    const [champions, setchampions] = useState()
    
    const [ChampionName, setChampionName] = useState("")

    const urlitems = 'http://ddragon.leagueoflegends.com/cdn/13.6.1/data/es_ES/item.json'
